...
public class RegisterPersonView extends JPanel {
	...
	private JTextField tipoTelField;
	...
	public RegisterPersonView() {
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(cpfField.getText().trim().isEmpty()) {
					...
					createEntityInDataBase.createPerson(pessoa);
					...
					createEntityInDataBase.createEndereco(endereco, pessoa.getCdPessoa());
		...
		/*
		JLabel lbltelefone = new JLabel("Tipo do telefone");
		lblCep.setFont(new Font("Roboto", Font.BOLD, 18));
		lbltelefone.setBounds(47, 376, 127, 20);
		add(lbltelefone);
		
		tipoTelField = new JTextField();
		tipoTelField.setToolTipText("Digite seu tipo do telefone...");
		tipoTelField.setColumns(10);
		tipoTelField.setBounds(159, 371, 219, 30);
		add(cepField);
		...
		dddField.setToolTipText("Digite seu DDD...");
		dddField.setColumns(10);
		dddField.setBounds(159, 371, 219, 30);
		add(cepField);
		
		JLabel lblNumeroTel = new JLabel("Numero");
		lblCep.setFont(new Font("Roboto", Font.BOLD, 18));
		lblCep.setBounds(47, 376, 127, 20);
		add(lblNumeroTel);
		
		telField = new JTextField();
		telField.setToolTipText("Digite seu numero de telefone...");
		telField.setColumns(10);
		telField.setBounds(159, 371, 219, 30);
		add(cepField);
		*/
	}
